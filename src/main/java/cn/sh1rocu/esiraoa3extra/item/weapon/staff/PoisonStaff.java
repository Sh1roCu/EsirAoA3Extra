...
public class PoisonStaff extends BaseStaff<Object> {
    ...
    public void cast(World world, ItemStack staff, LivingEntity caster, Object args) {
        PoisonShotEntity poisonShot = new PoisonShotEntity(caster, this, 60);
        createEnergyShot(world, staff, caster, poisonShot);
    }
    ...
    public boolean doEntityImpact(BaseEnergyShot shot, Entity target, LivingEntity shooter) {
        ...
        if (DamageUtil.dealMagicDamage(shot, shooter, target, getDmg() * totalMod, false)) {
            EntityUtil.applyPotions(target, new EffectBuilder(Effects.POISON, 220));
