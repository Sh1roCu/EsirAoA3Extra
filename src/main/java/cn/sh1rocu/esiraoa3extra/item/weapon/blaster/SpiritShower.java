...
public class SpiritShower extends BaseBlaster {
    ...
    public void fire(ItemStack blaster, LivingEntity shooter) {
        ShowerShotEntity showerShot = new ShowerShotEntity(shooter, this, 60);
        WeightedShowerShotEntity weightedShowerShot = new WeightedShowerShotEntity(shooter, this, 60);
        HeavyShowerShotEntity heavyShowerShot = new HeavyShowerShotEntity(shooter, this, 60);
