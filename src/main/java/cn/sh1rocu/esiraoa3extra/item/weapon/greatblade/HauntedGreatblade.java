...
public class HauntedGreatblade extends BaseGreatblade {
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean isSelected) {
        if (!world.isClientSide && isSelected && entity instanceof PlayerEntity && RandomUtil.oneInNChance(12000)) {
            ...
            TranslationTextComponent component = LocaleUtil.getLocaleMessage("item.esiraoa3extra.haunted_greatblade.message." + (1 + random.nextInt(16)), TextFormatting.DARK_PURPLE);
