...
public class RunicArmour extends AdventArmour {
    ...
    public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(LocaleUtil.getFormattedItemDescriptionText("item.esiraoa3extra.runic_armour.desc.2", LocaleUtil.ItemDescriptionType.BENEFICIAL));
        tooltip.add(LocaleUtil.getFormattedItemDescriptionText("item.esiraoa3extra.runic_armour.desc.3", LocaleUtil.ItemDescriptionType.NEUTRAL));
    }
}
